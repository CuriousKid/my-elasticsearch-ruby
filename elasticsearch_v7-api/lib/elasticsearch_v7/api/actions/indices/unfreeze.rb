  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @note This feature is available in the Platinum distribution of ElasticsearchV7.
        #
        ...
        def unfreeze(arguments = {})
          ...
          path = ElasticsearchV7::API::Utils.__pathify ElasticsearchV7::API::Utils.__listify(index), '_unfreeze'
          params = ElasticsearchV7::API::Utils.__validate_and_extract_params arguments, valid_params
