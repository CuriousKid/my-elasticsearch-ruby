...
#
#   Follow the documentation on how to add the github.token file from the Elasticsearch RM documentation
#   - https://github.com/elastic/elasticsearch-team/blob/master/onboarding-and-how-we-work/development_process.md#prepare-your-development-environment
#   - Under section 10
#
