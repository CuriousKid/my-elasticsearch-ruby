        ...
        module Actions
          ...
          def get_privileges(arguments = {})
            ...
            path   = if _application && _name
                       "_security/privilege/#{ElasticsearchV7::API::Utils.__listify(_application)}/#{ElasticsearchV7::API::Utils.__listify(_name)}"
                     elsif _application
                       "_security/privilege/#{ElasticsearchV7::API::Utils.__listify(_application)}"
                     else
                       "_security/privilege"
  end
            params = {}
