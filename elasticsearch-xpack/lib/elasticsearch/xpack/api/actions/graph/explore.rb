        ...
        module Actions
          ...
          def explore(arguments = {})
            ...
            path   = if _index && _type
                       "#{ElasticsearchV7::API::Utils.__listify(_index)}/#{ElasticsearchV7::API::Utils.__listify(_type)}/_graph/explore"
                     else
                       "#{ElasticsearchV7::API::Utils.__listify(_index)}/_graph/explore"
  end
