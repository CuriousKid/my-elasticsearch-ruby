        ...
        module Actions
          ...
          def rollup_search(arguments = {})
            ...
            path   = if _index && _type
                       "#{ElasticsearchV7::API::Utils.__listify(_index)}/#{ElasticsearchV7::API::Utils.__listify(_type)}/_rollup_search"
                     else
                       "#{ElasticsearchV7::API::Utils.__listify(_index)}/_rollup_search"
  end
