        ...
        module Actions
          ...
          def delete_forecast(arguments = {})
            ...
            path   = if _job_id && _forecast_id
                       "_ml/anomaly_detectors/#{ElasticsearchV7::API::Utils.__listify(_job_id)}/_forecast/#{ElasticsearchV7::API::Utils.__listify(_forecast_id)}"
                     else
                       "_ml/anomaly_detectors/#{ElasticsearchV7::API::Utils.__listify(_job_id)}/_forecast"
  end
