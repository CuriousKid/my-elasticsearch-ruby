        ...
        module Actions
          ...
          def get_model_snapshots(arguments = {})
            ...
            path   = if _job_id && _snapshot_id
                       "_ml/anomaly_detectors/#{ElasticsearchV7::API::Utils.__listify(_job_id)}/model_snapshots/#{ElasticsearchV7::API::Utils.__listify(_snapshot_id)}"
                     else
                       "_ml/anomaly_detectors/#{ElasticsearchV7::API::Utils.__listify(_job_id)}/model_snapshots"
  end
